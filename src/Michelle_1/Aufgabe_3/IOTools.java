 ...
 * werden diverse Werte von der Tastatur eingelesen, die jeweils durch ein Leerzeichen, einen
 * Tabstop oder ein Zeilenendezeichen getrennt sein m&uuml;ssen.
 *
...
public class IOTools {
  ...
  /**
   * L&ouml;scht alles, was sich in der momentanen Zeile befindet. Das hei&szlig;t es wird der
   * Eingabe bis zum Zeilenende keine Beachtung mehr geschenkt
   */
  ...
  private static void init() {
    ...
    while (eingabe == null || !eingabe.hasMoreTokens()) eingabe = new StringTokenizer(readLine());
  }
  ...
  /**
   * Liest eine ganze Textzeile von der Tastatur ein. Soll vorher eine Eingabeaufforderung gemacht
   * werden, geschieht dies durch den Parameter. Dieser kann jedoch auch wegfallen.
   *
  ...
  /**
   * Liest eine <CODE>Int</CODE>egerzahl von der Tastatur ein. Soll vorher eine Eingabeaufforderung
   * gemacht werden, geschieht dies durch den Parameter. Dieser kann jedoch auch wegfallen.
   *
   * @param prompt eine eventuelle Eingabeaufforderung
  ...
  /**
   * Liest eine <CODE>Long</CODE>zahl von der Tastatur ein. Soll vorher eine Eingabeaufforderung
   * gemacht werden, geschieht dies durch den Parameter. Dieser kann jedoch auch wegfallen.
   *
   * @param prompt eine eventuelle Eingabeaufforderung
   * @return die eingelesene Zahl.
  ...
  /**
   * Liest eine <CODE>Double</CODE>zahl von der Tastatur ein. Soll vorher eine Eingabeaufforderung
   * gemacht werden, geschieht dies durch den Parameter. Dieser kann jedoch auch wegfallen.
   *
   * @param prompt eine eventuelle Eingabeaufforderung
   * @return die eingelesene Zahl.
  ...
  /**
   * Liest eine <CODE>Float</CODE>zahl von der Tastatur ein. Soll vorher eine Eingabeaufforderung
   * gemacht werden, geschieht dies durch den Parameter. Dieser kann jedoch auch wegfallen.
   *
   * @param prompt eine eventuelle Eingabeaufforderung
   * @return die eingelesene Zahl.
  ...
  /**
   * Liest eine <CODE>Short</CODE>zahl von der Tastatur ein. Soll vorher eine Eingabeaufforderung
   * gemacht werden, geschieht dies durch den Parameter. Dieser kann jedoch auch wegfallen.
   *
   * @param prompt eine eventuelle Eingabeaufforderung
   * @return die eingelesene Zahl.
  ...
  /**
   * Liest einen boolschen Wert von der Tastatur ein. Soll vorher eine Eingabeaufforderung gemacht
   * werden, geschieht dies durch den Parameter. Dieser kann jedoch auch wegfallen.
   *
   * @param prompt eine eventuelle Eingabeaufforderung
  ...
  public static boolean readBoolean(String prompt) {
    ...
    while (!try_this.equals("true") && !try_this.equals("false")) try_this = readString();
    return try_this.equals("true");
  }

  /**
   * Liest ein Textwort von der Tastatur ein. Soll vorher eine Eingabeaufforderung gemacht werden,
  ...
  /**
   * Liest ein Zeichen von der Tastatur ein. Soll vorher eine Eingabeaufforderung gemacht werden,
   * geschieht dies durch den Parameter. Dieser kann jedoch auch wegfallen.
   *
   * @param prompt eine eventuelle Eingabeaufforderung
  ...
  public static char readChar(String prompt) {
    char erg;
    System.out.print(prompt);
    if (zeichenkette == null || zeichenkette.length() == 0) zeichenkette = readString("");
  ...
  /**
   * Wandelt eine double-Zahl in einen String um. Bei der &uuml;blichen Umwandlung von double-Werten
   * in einen String findet eine Rundung statt. So wird etwa die Zahl 0.1, obwohl intern nicht
   * darstellbar, dennoch auf dem Bildschirm ausgegeben. Diese Methode umgeht die Rundung
   */
